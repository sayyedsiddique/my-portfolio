...
export const services: Iservices[] = [
  ...
  { title: "UI/UX Designer", about: "when an unknown printer took a galley of type and scrambled it to make a type specimen book", Icon: RiComputerLine },
  { title: "Whatever", about: "when an unknown printer took a galley of type and scrambled it to make a type specimen book", Icon: RiComputerLine },
];
