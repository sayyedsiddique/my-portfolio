...
import { CUSTOM_DROPDOWN_STYLE } from "../utils/constantFunction";
import Select from 'react-select';
import { languagesData } from "../utils/contactData";
...
const MainPortfolio: React.FC<MainPortfolioProps> = ({languageSelectHandler, selectedLang}) => {
  return (
    <div className="grid lg:h-screen grid-cols-12 gap-6 px-5 py-4 lg:px-48 grid-12 sm:px-20 md:px-32">
